...
ax1.axvline(x=elbo_converged_it[0], color='b', linestyle='--')
ax2.plot(np.trim_zeros(predictive, 'b'), color='b', label="Uniform")
ax2.axvline(x=predictive_converged_it[0], color='b', linestyle='--')
...
ax2.plot(np.trim_zeros(predictive, 'b'), color='g', label="True")
ax2.axvline(x=predictive_converged_it[1], color='g', linestyle='--')
...
ax2.plot(np.trim_zeros(predictive, 'b'), color='r', label="Random")
ax2.axvline(x=predictive_converged_it[2], color='r', linestyle='--')
...
ax2.plot(np.trim_zeros(predictive, 'b'), color='c', label="Unique")
ax2.axvline(x=predictive_converged_it[3], color='c', linestyle='--')
...
ax1.axvline(x=elbo_converged_it[5], color='y', linestyle='--')
...
ax1.axvline(x=elbo_converged_it[6], color='k', linestyle='--')
...
ax1.axvline(x=elbo_converged_it[7], color='brown', linestyle='--')
